...
let  randomNumber = Math.floor(Math.random()*breakingBadQuotes.length);
document.getElementById('text').innerHTML=breakingBadQuotes[randomNumber].quote;
document.getElementById('author').innerHTML=breakingBadQuotes[randomNumber].author;
function newQuote() {
    let  randomNumber = Math.floor(Math.random()*breakingBadQuotes.length);
    document.getElementById('text').innerHTML=breakingBadQuotes[randomNumber].quote;
    document.getElementById('author').innerHTML=breakingBadQuotes[randomNumber].author;
